...
export const PAYMENTS = [
    { name: 'Dana', icon: 'https://i.ibb.co/1nL07f3/dana.png' },
    { name: 'Gopay', icon: 'https://i.ibb.co/Ld230qF/gopay.png' },
    { name: 'ShopeePay', icon: 'https://i.ibb.co/JnHb84J/shopeepay.png' },
    { name: 'OVO', icon: 'https://i.ibb.co/5cQf1qB/ovo.png' },
    { name: 'QRIS', icon: 'https://i.ibb.co/Q8Q9Y0w/qris.png' },
    { name: 'Bank Krom', icon: 'https://files.catbox.moe/0a5j7j.png' }
];

export const PROMOS = [
    { src: 'https://files.catbox.moe/k3b8d0.png', alt: 'Promo 1' },
    { src: 'https://files.catbox.moe/k3b8d0.png', alt: 'Promo 2' },
    { src: 'https://files.catbox.moe/k3b8d0.png', alt: 'Promo 3' }
];
